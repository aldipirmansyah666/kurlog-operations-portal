...
import { PackageSearch, ShoppingBag, AlertTriangle, FileCheck, Users, LogOut, Shield, Database, Layers } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/data-lengkap-utama', label: 'Data Lengkap Utama', icon: Layers },
