  ...
  return (
    ...
    >
      <div className="space-y-4">
        <div className="bg-slate-50 border border-[#E2E8F0] rounded-lg p-3 text-xs text-slate-500 space-y-1.5">
          <p className="font-medium text-slate-700">
            Copy dari Excel lalu paste langsung di sini (tab-separated, tanpa header).
          </p>
          <p>
            Urutan kolom mengikuti template master (sheet Agen CUM). Bagian <span className="font-semibold text-slate-600">STATUS</span>:
            ...
            <span className="font-semibold text-slate-600"> KURLOG</span>: POS + PPOB, POS ONLY, SICEPAT.
          </p>
          <p>
            Lanjut: <span className="font-mono">PPID, NAMA LOKET DI ONPAYS, NAMA LOKET DI KURLOG, NAMA PEMILIK,
